...
/**
 * The list of all the names of places in Middle Earth that we will be using
 */
string all_city_names[] = {
  ...
  *
  *@param xsize the size of the x-axis of Middle-Earth
  *@param ysize the size of the y-axis of Middle-Earth
  *@param num_cities the number of cities in Middle-Earth
  *@param seed the seed used to generate Middle-Earth
  *
  */
 ...
 *
 * Sauron destroys all of Middle-Earth
 */
...
/** @brief prints the cities of middle earth to the console
 *
 * The Mouth of Sauron, telling everyone everywhere in Middle-Earth
 */
...
/** @brief prints a table of distances to the console
 *
 *prints a tab seperated table of the distances between each of the cities (can be loaded into excel)
 ...
 *
 *Calculates and returns the distance between two cities from the array of distances
 *@param city1 the name of the first city
 *@param city2 the name of the second city
 *@return returns a float of the distance between the two cities
 */
...
/**@brief returns a vector of the cities traveled to
 *
 *Returns a vector of all of the cities traveled to. The first city is the start and end point. The number of cities passed in is 1 less than the size of the returned vector as it doesn't include the start and end point.
 *@param length number of cities not including start
 *@return returns a vector of all visited cities
 */
